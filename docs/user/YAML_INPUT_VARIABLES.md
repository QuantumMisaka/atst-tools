...
| runtime.threads | runtime | `int \| 'auto' \| NoneType` | `null` | Process thread budget applied before the scientific stack is imported; 'auto' follows the CPU affinity mask. |
