...
| `.trae/documents/Zn-NEB.md` | `docs/archive/pending_delete/trae/documents/Zn-NEB.md` | 初版 Zn 单路径计划已被分段 Zn runtime report 取代。 |
| `.trae/specs/plan-zn-neb-calculations/checklist.md` | `docs/archive/pending_delete/trae/specs/plan-zn-neb-calculations/checklist.md` | 初始 Zn spec checklist 已被分段方案取代，未完成项不再代表当前执行路径。 |
| `.trae/specs/plan-zn-neb-calculations/spec.md` | `docs/archive/pending_delete/trae/specs/plan-zn-neb-calculations/spec.md` | 初始 Zn calculation spec 已被分段方案取代。 |
| `.trae/specs/plan-zn-neb-calculations/tasks.md` | `docs/archive/pending_delete/trae/specs/plan-zn-neb-calculations/tasks.md` | 初始 Zn task list 已被分段 runtime report 取代。 |
