...
- [ ] NEB 图数 × 卡数映射（P0 复核新增）：4/8 内部图 × 1/2/4/8 卡；验证“图数 ≤ 卡数”的延迟收益与 8 ranks/1 卡的压力边界（站点已测：3 ranks/1 卡≈9.9 s、Σ35 次力调用；4 内部图 × 4 卡（`srun --mpi=pmix_v5 --gpus-per-task=1`）11.8/9.9 s、`world_size=4`、Σ38 次；**8 ranks/1 卡已于 2026-09-21 完成**（1436926/1436941：串行 11.2–13.6 s vs 8 rank 16.3–20.5 s，1.2–1.8×、显存峰值 16.6 GB / 32 GB，见 SAI 报告 §5d；本地 7.7× 的外推不适用于 V100）；8 图/8 卡留后续，需站点协调超出 QOS 的卡数）。
