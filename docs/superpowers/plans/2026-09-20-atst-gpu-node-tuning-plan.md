...
- [ ] 候选正式点至少三次交替重复，保留失败；host/SIF 成对验证，采样开/关检查观测开销（DP 已 3 次交替重复；ABACUS NEB 3 次（750.2/712.7/709.8 s）、relax 4 次（172.8/171.0/171.7/172.6 s）；全部失败样本保留；采样开/关 A/B 已有本地与站点两遍对照；**host/SIF 成对未做**，留后续）。
